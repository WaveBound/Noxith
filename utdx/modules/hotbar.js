...
function initHotbar() {
    ...
    if (!document.getElementById('unitHotbar')) {
        ...
        const bufferUnits = [
            ...
            { id: 'water_god', name: 'Enlightened God', img: 'images/units/EnlightenedGod.png' }
        ];
...
function showFusionImages(armorIds) {
    ...
    armorIds.forEach(id => {
        ...
        if (unit) {
            ...
            contentHtml += `
                <div class="fusion-card-overlay" onclick="event.stopPropagation(); addUnitToHotbar({id: '${id}'}, true); closeModal('universalModal');">
                    <img src="${fusionImg}" class="fusion-bg-img-clean" onerror="this.src='${unit.img}'">
                    
                    <div class="fusion-stats-box-full-build">
    ...
    slots.forEach((slot, i) => {
        ...
        if (unit) {
            ...
            if (armorIds && armorIds.length > 0) {
                ...
                fusionBadge.className = 'fusion-badge interactive';
                fusionBadge.innerText = 'FUSION';
