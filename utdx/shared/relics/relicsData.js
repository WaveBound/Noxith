...
const EXCLUSIVE_HEADS = [
    {
        id: "flaming_donut",
        name: "Flaming Donut",
        search: "Donut",
        cls: "custom",
        exclusiveTo: ["ace"], // Works if window.isUnit(uStats.id, 'ace')
        bonus: { dmg: 100 }
    },
    {
        id: "berserk_cleaver",
        name: "Berserk Cleave",
        search: "Berserk Cleave",
        cls: "berserk",
        exclusiveTo: ["kenpachi"],
        bonus: { dmg: 400 }
    },
    {
        id: "sorcerer_hunter_spirit",
        name: "S.H. Spirit",
        search: "S. Hunter",
        cls: "custom",
        exclusiveTo: [], // Logic handled via passive or noCrits=true
        noCrits: true
    },
    {
        id: "strongest_sorcerer_glasses",
        name: "Strongest",
        search: "Strongest",
        cls: "custom",
        exclusiveTo: ["the_strongest_of_today"],
        bonus: { dmg: 50 }
    },
    {
        id: "bloodline_head",
        ...
        search: "Bloodline",
        cls: "ninja",
        exclusiveTo: ["alpha_devil", "devil_hunter", "ancient_mage", "mimicry_sorcerer"],
        bonus: { dmg: 30 }
    },
    {
        id: "mochi_scarf",
        ...
        search: "Scarf",
        cls: "custom",
        exclusiveTo: [], // Handles special burn logic in relic-backend
    },
    {
        id: "ulquiorra_wings",
...
window.SETS = SETS;
window.EXCLUSIVE_HEADS = EXCLUSIVE_HEADS;
